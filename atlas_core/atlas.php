...
require_once("theme_support.php"); // our page layout editor
require_once("performance.php"); // our page layout editor
require_once("images.php"); // our page layout editor
require_once("search.php"); // our page layout editor
require_once("blocks/blocks.php"); // our page layout editor
